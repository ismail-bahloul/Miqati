...
mod tests {
    ...
    #[test]
    fn calibration_casablanca_against_aladhan() {
        // Reference values from the AlAdhan API for Casablanca (33.5731,
        // -7.5898) on 2026-09-19, method 21 (Morocco: Fajr=19°, Isha=17°,
        // Dhuhr+5/Maghrib+5), UTC+1 (Morocco is UTC+1 outside Ramadan).
        // AlAdhan: Fajr 05:48, Sunrise 07:16, Dhuhr 13:29, Asr 16:54,
        // Maghrib 19:36, Isha 20:50.
        ...
        let t = b.build(date, 33.5731, -7.5898, 1.0).times;
        let cases = [
            (t.fajr, "05:48", 3.0),
            (t.sunrise, "07:16", 3.0),
            (t.dhuhr, "13:29", 3.0),
